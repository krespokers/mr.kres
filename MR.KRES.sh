...
echo -e $white"         # $red contact: mrcakil@programmer.net $white            #"
echo -e $red"         # $white greetz :99syndicate - Anonymous Cyber team $red#"
echo -e $white"         # $white copyright : ./Mr Cakil     $white                #"
echo -e $red"         # $white thanks to : 4wsec - Mr.Tenwap $red             #"
echo -e $white"         ***********************************************"
echo ""
echo -e $white"         ******************WEB*****************************"
...
then
clear
echo -e $green" yukichan "
sleep 1
apt-get update && apt-get upgrade
apt-get install git
git clone https://github.com/Yukinoshita47/Yuki-Chan-The-Auto-Pentest.git
cd Yuki-Chan-The-Auto-Pentest
chmod 777 wafninja jomscan install-perl-module.sh yuki.sh && chmod 777 Module/WhatWeb/whatweb && ./install-perl-module.sh && ./yuki.sh
sleep 1
echo -e $red" Done Install cuk "
fi
...
then
clear
echo -e $green" DrupalGeddon "
sleep 1
apt-get update && apt-get upgrade
apt-get install git
pkg install ruby-dev clang make
gem install jekyll
pip install requests
git clone https://github.com/dreadlocked/Drupalgedon2
sleep 1
echo -e $red" Done Install cuk "
fi
...
sleep 1
echo -e $green" contact : mrcakil@programmer.net "
sleep 1
echo -e $red" fb : https://www.facebook.com/dendisaimam.dendisaimam.1 "
sleep 1
echo -e $red" Bye ea :* "
sleep 1
exit
